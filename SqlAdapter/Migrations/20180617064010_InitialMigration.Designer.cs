...
namespace SqlAdapter.Migrations
{
    ...
    [Migration("20180617064010_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Queries.UserWithPostNumberQuery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("LatestTitleChange");
                    ...
                    b.ToTable("UserWithPostNumberQuerys");
                });
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    b.HasOne("Domain.Posts.Post", "PinnedPost")
                        .WithMany()
